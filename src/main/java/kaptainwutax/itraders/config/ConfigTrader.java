...
public class ConfigTrader extends Config {
	...
	protected void resetConfig() {
		...
		this.TRADES.add(
				new Trade(new Product(Items.APPLE, 0, 8, null), null, new Product(Items.GOLDEN_APPLE, 0, 1, null)));
		this.TRADES.add(new Trade(new Product(Items.GOLDEN_APPLE, 0, 8, null), null,
				new Product(Items.GOLDEN_APPLE, 1, 1, null)));
		...
		this.TRADES
				.add(new Trade(new Product(Items.GOLDEN_APPLE, 1, 8, null), null, new Product(Items.STICK, 0, 1, nbt)));
	}
