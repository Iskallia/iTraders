...
public class TileEntityCubeChamber extends TileInventoryBase {
    ...
    public boolean startPressed() {
        ...
        // TODO: Consume 1 Booster once successfully started, but store the used booster for later!
    ...
    protected ItemHandlerTile createNewItemHandler() {
        ...
        return new ItemHandlerTileFiltered(this) {
            ...
            public ItemStack insertItem(int slot, ItemStack stack, boolean simulate) {
                // TODO: input item to proper slot. Remember, index 0 for input, index 1 for booster! :D
