...
public class InitItem {
	...
	public static ItemMagicCrystal MAGIC_CRYSTAL = new ItemMagicCrystal("magic_crystal");
	...
	public static ItemChanceBag CHANCE_BAG_COMMON = new ItemChanceBag("chance_bag_common", EnumRarity.COMMON);
	public static ItemChanceBag CHANCE_BAG_RARE = new ItemChanceBag("chance_bag_rare", EnumRarity.RARE);
	public static ItemChanceBag CHANCE_BAG_EPIC = new ItemChanceBag("chance_bag_epic", EnumRarity.EPIC);
	...
	public static void registerItems(IForgeRegistry<Item> registry) {
		...
		registerItem(MAGIC_CRYSTAL, registry);
		...
		registerItem(CHANCE_BAG_COMMON, registry);
		registerItem(CHANCE_BAG_RARE, registry);
		registerItem(CHANCE_BAG_EPIC, registry);
	}
