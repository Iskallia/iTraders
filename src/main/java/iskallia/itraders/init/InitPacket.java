...
import iskallia.itraders.net.packet.C2SReactorToggle.C2SReactorToggleHandler;
...
public class InitPacket {
	...
	public static void registerPackets() {
		...
		PIPELINE.registerMessage(C2SReactorToggleHandler.class, C2SReactorToggle.class, nextId(), Side.SERVER);
	}
