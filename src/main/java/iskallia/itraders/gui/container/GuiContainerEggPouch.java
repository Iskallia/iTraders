...
import iskallia.itraders.gui.component.GuiScrollbar;
...
public class GuiContainerEggPouch extends GuiContainer {
	...
	public void initGui() {
		...
		// Search bar
		this.searchField = new GuiTextField(0, this.fontRenderer, (this.width / 2) - 68, (this.height / 2) - 100, 140,
		...
		// Scroll bar
		this.scrollbar = new GuiScrollbar((this.width / 2) + 79, (this.height / 2) - 84, 107);
	...
	public void setScroll(int currentScroll, int totalScroll) {
		this.scrollbar.setScroll(Math.max(currentScroll, 1), Math.max(totalScroll, 1));
