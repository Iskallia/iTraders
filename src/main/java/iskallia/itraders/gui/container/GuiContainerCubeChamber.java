...
public class GuiContainerCubeChamber extends GuiContainer {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.startButton.enabled = !cubeChamber.getInventoryHandler().getStackInSlot(0).isEmpty() && cubeChamber.getInventoryHandler().getStackInSlot(2).isEmpty();
		...
		this.drawTexturedModalRect(startX + 9, startY + 8 + powerScaled, 178, 22 + powerScaled, 17, 69 - powerScaled);
		...
		this.fontRenderer.drawString("RF", startX + 12, startY + 67, 4210752);
